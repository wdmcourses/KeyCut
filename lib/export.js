...
async function startExport({ src, segments, out, tmpDir, ffmpeg, onProgress, videoTimebase, hasThumbnail, streams, compress, resolution, duration, rotation }) {
  _exportCancelled = false;
...
module.exports = { startExport, killExport, exportCancelled, resetExportCancelled, runFfmpeg };